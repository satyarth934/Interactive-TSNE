...
class PrepareDataGLMLatent:
    ...
    def __init__(self, csv_path, data_dir, method='tsne', perplexity=30, n_jobs=4, n_neighbors=5):
        # self.model = model
        ...
        self.tsne_obj, self.spd, self.cl, self.objects = self.variable_gen(self.embeddings, self.num_clusters, method, perplexity, n_jobs, n_neighbors)
    ...
    def variable_gen(self, embeddings, num_clusters, method, perplexity, n_jobs, n_neighbors):
        '''
        ...
        filenames = [os.path.join(self.data_dir, f) for f in self.encoded_samples['input_data_filename']]
